...
<body>
                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Makanan Berat</h2>
    ...
    <img src="../assets/img/nasigoreng.jpg" class="card-img-top" alt="gambar">
        <div class="card-body">
...
<div class="card" style="width: 18rem;">
    <img src="../assets/img/nasicampur.jpg" class="card-img-top" alt="gambar">
        <div class="card-body">
            <h5 class="card-title">Nasi Campur</h5>
                <p class="card-text">
                Nasi Campur adalah makan berupa nasi yang dicampur dengan berbagai macam lauk dan pendampingnya.
                </p>
        </div>
    <ul class="list-group list-group-flush">
        <li class="list-group-item">Harga : Rp.12.000.-/Porsi</li>
    </ul>
    <div class="card-body">
        <a href="#" class="card-link">Lihat</a>
        <a href="#" class="card-link">Beli</a>
...
<div class="card" style="width: 18rem;">
    <img src="../assets/img/sate.jpg" class="card-img-top" alt="gambar">
        <div class="card-body">
...
<div class="card" style="width: 18rem;">
    <img src="../assets/img/migoreng.jpg" class="card-img-top" alt="gambar">
        <div class="card-body">
            <h5 class="card-title">Mi Goreng</h5>
                <p class="card-text">
                Mi Goreng adalah makanan yang terbuat dari mi buatan yang diberi tambahan seperti sayur - sayuran lalu digoreng. 
                </p>
        </div>
    <ul class="list-group list-group-flush">
        <li class="list-group-item">Harga : Rp.13.000.-/Porsi</li>
    </ul>
    <div class="card-body">
        <a href="#" class="card-link">Lihat</a>
        <a href="#" class="card-link">Beli</a>
