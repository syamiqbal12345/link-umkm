...
<body>
                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Kerajinan</h2>
    ...
    <img src="../assets/img/vas.jpg" class="card-img-top" alt="gambar">
        <div class="card-body">
            <h5 class="card-title">Vas Koran</h5>
                <p class="card-text">
                Vas Koran adalah Vas yang terbuat dari koran - koran bekas yang dipergunakan kembali untuk membuat kerajinan semacam vas.
            </p>
        </div>
    <ul class="list-group list-group-flush">
        <li class="list-group-item">Harga : Rp.35.000.-/Pcs</li>
    </ul>
    <div class="card-body">
...
<div class="card" style="width: 18rem;">
    <img src="../assets/img/karikatur.jpg" class="card-img-top" alt="gambar">
        <div class="card-body">
            <h5 class="card-title">Stik Handcraft</h5>
                <p class="card-text">
                Stik Handcraft adalah sebuah kerajinan tang yang terbuat dari stik es krim yang dapat dibuat bermacam macam bentuk.
                </p>
        </div>
    <ul class="list-group list-group-flush">
        <li class="list-group-item">Harga : Rp.40.000.- - Rp.120.000.-/Pcs</li>
    </ul>
    <div class="card-body">
        <a href="#" class="card-link">Lihat</a>
        <a href="#" class="card-link">Beli</a>
...
<div class="card" style="width: 18rem;">
    <img src="../assets/img/tas.jpg" class="card-img-top" alt="gambar">
        <div class="card-body">
            <h5 class="card-title">Tas Manik</h5>
                <p class="card-text">
                Tas Manik adalah Tas kerajinan tangan yang terbuat dari bermacam - macam bentuk dan warna yang berasal dari manik - manik
                </p>
        </div>
    <ul class="list-group list-group-flush">
        <li class="list-group-item">Harga : Rp.70.000.-/Kg</li>
    </ul>
    <div class="card-body">
        <a href="#" class="card-link">Lihat</a>
        <a href="#" class="card-link">Beli</a>
